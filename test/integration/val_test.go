...
func TestVALContentAllLocales(t *testing.T) {
	...
	assert.NotNil(t, content.Characters[0].LocalizedNames.EnUS, "expecting non-nil localized character name")
}
...
func TestVALRankedLeaderboard(t *testing.T) {
	...
	assert.Equal(t, "3e47230a-463c-a301-eb7d-67bb60357d4f", leaderboard.ActID, "expecting non-nil leaderboard")
}
