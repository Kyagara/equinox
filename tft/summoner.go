...
func (s *SummonerEndpoint) ByName(region lol.Region, summonerName string) (*SummonerDTO, error) {
	return s.getSummoner(fmt.Sprintf(SummonerByNameURL, summonerName), region, "", "ByName")
}

// Get a summoner by summoner account ID.
func (s *SummonerEndpoint) ByAccountID(region lol.Region, accountID string) (*SummonerDTO, error) {
	return s.getSummoner(fmt.Sprintf(SummonerByAccountIDURL, accountID), region, "", "ByAccountID")
}

// Get a summoner by summoner PUUID.
func (s *SummonerEndpoint) ByPUUID(region lol.Region, PUUID string) (*SummonerDTO, error) {
	return s.getSummoner(fmt.Sprintf(SummonerByPUUIDURL, PUUID), region, "", "ByPUUID")
}

// Get a summoner by summoner ID.
func (s *SummonerEndpoint) ByID(region lol.Region, PUUID string) (*SummonerDTO, error) {
	return s.getSummoner(fmt.Sprintf(SummonerByIDURL, PUUID), region, "", "ByID")
}

// Get a summoner by access token.
func (s *SummonerEndpoint) ByAccessToken(region lol.Region, accessToken string) (*SummonerDTO, error) {
	return s.getSummoner(SummonerByAccessTokenURL, region, accessToken, "ByAccessToken")
}

func (s *SummonerEndpoint) getSummoner(url string, region lol.Region, accessToken string, methodName string) (*SummonerDTO, error) {
